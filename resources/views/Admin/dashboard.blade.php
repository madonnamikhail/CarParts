                    ...
                    <div class="row mb-30">
                        <div class="col-md-6">
                            ...
                            <div class="progress progress-small">
                                <div class="skill2-bar bg-success" role="progressbar" style="width: 70%" aria-valuenow="70"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="progress progress-small">
                                <div class="skill2-bar bg-danger" role="progressbar" style="width: 30%" aria-valuenow="30"
                                    aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="year" role="tabpanel" aria-labelledby="year-tab">
                                <div class="row mb-30">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <p class="sm-mb-5 d-block">Understanding the price and having the willingness to
                                            pay. </p>
                                ...
                                <div class="row mb-30">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <p class="sm-mb-5 d-block">Motivators for your personality and your personal goals.
                                        </p>
