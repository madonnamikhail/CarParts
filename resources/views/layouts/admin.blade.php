                    ...
                    <div class="scrollbar side-menu-bg">
                        <ul class="nav navbar-nav side-menu" id="sidebarnav">
                            ...
                            <li>
                                ...
                                <ul id="admins-roles" class="collapse @if(Request::is('admin/admins*') || Request::is('admin/roles*') ) show @endif" data-parent="#sidebarnav">
                                    <li class="@if(Request::is('admin/admins*')) active @endif"><a href="{{ route('admins.index') }}">المُشرفين</a></li>
                                    <li class="@if(Request::is('admin/roles*')) active @endif"><a href="{{ route('roles.index') }}">والوظائف</a></li>
                                </ul>
                            </li>
